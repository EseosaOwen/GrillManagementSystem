...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-chartbg" data-col="2-columns">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <%@include file="adminNavBar/main_admin_nav.jsp"%>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <span class="avatar">
                            <img src="admin/theme-assets/images/portrait/small/avatar-s-2.png" alt="avatar">
                        </span>
                        <span class="avatar">
                            <img src="admin/theme-assets/images/portrait/small/avatar-s-3.png" alt="avatar">
                        </span>
                        <span class="avatar">
                            <img src="admin/theme-assets/images/portrait/small/avatar-s-4.png" alt="avatar">
                        </span>
                    </div>
                </div>
    ...
    <div class="col-xl-4 col-lg-12">
        <div class="card">
            <div class="card-content">
                ...
                <div id="carousel-area" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="admin/theme-assets/images/carousel/blogpost5.jpg" class="d-block w-100 h-100" alt="First slide" height="100" >
                        </div>
                        <div class="carousel-item">
                            <img src="admin/theme-assets/images/carousel/gallery-img5.jpg" class="d-block w-100 h-100" alt="Second slide" 
                                height="100" >
                        </div>
                        <div class="carousel-item">
                            <img src="admin/theme-assets/images/carousel/01.jpg" class="d-block w-100 h-100" alt="Third slide" height="100">
                        </div>
                        <div class="carousel-item">
                            <img src="admin/theme-assets/images/carousel/product5.jpg" class="d-block w-100 h-100" alt="Fourth slide" height="100" >
                        </div>
                ...
                <div class="card-body">
                    <a href="#" class="card-link">Slides of Grills best delicacies</a>
                    <a href="index" class="card-link">GrillS home page</a>
                </div>
            </div>
