	...
	<div class="col-12">
		<div class="card">
			...
			<div class="card-content collapse show">
				<div class="card-body">
					<p class="card-text">Admin Can see now see orders for Grill<code>.management</code></p>
					<p><span class="text-bold-600">Grill:</span>Order List</p>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
                                                                    ...
                                                                    <td><c:out value="${order.foodname}"/></td>
                                                                    <td><c:out value="${order.deliveryopt}"/></td>
                                                                    <td><c:out value="${order.modeofpay}"/></td>
                                                                     <td class="project-actions text-right">
                                                <a class="btn btn-danger btn-sm" href="delete-order?id=<c:out value="${order.id}" />">
